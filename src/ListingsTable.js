...
const ListingTable = () => {
    return (
        <div className="lg:w-[440px] md:w-[440px] w-full rounded-[20px] mt-4 h-[418px] border-[1px] border-[#EFEFEF]">
        <div className="p-[20px] lg:w-[430px] md:w-[440px] w-full rounded-[20px] mt-4 overflow-y-scroll h-[383px]">   
            <a className="absolute text-[20px] font-bold  font-[InterRegular] bg-white lg:w-[400px] md:w-[380px] mt-[-20px] h-[33px] mr-[20px]">Listing</a>
